...
cantidad_heroes = len(heroes_para_reclutar)
i=0

seleccion_heroes = {}

for heroe in range(cantidad_heroes):
   # print(heroes_para_reclutar[i])
    for info in heroes_info:
        if (heroe == info):
            seleccion_heroes[heroes_para_reclutar(i)] = heroes_info[info]

    for clave in seleccion_heroes:
        print(clave[i])
